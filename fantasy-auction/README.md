# Fancy Football League — Auction Valuation Model
...
Your pasted 2025 roster/salary data, cleaned by `auction_model/data_pipeline.py`:
...
This session has no live data feed and network access is locked to this
repo, so it could not pull real 2026 stat projections — copy
`data/projections_2026.template.csv` to `data/projections_2026.csv` and
either:
